...
RestrictedSecretChatWarning = 'Para pegar ou digitar um secreto, você deve inserir a Senha de pais. Você pode desativar esta solicitação alterando as suas opções de Amigos secretos.'
...
SCMenuVictoryParties = 'FESTAS DA VITÔRIA'
...
SCMenuSellbotInvasion = 'Invasão De Rôbos Vendedores'
...
FriendSecretNeedsPasswordWarning = 'Para pegar ou digitar um Secreto, você deve inserir a Senha de pais. Você pode desativar esta solicitação alterando as suas opções de Amigos secretos.'
...
FriendSecretIntro = 'Se você estiver jogando Toontown Online da Disney com alguém que conhece no mundo real, poderá tornar-se Amigo secreto dessa pessoa. Você pode conversar com seus Amigos secretos usando o teclado. Os outros Toons não entenderão o que vocês estiverem falando.\n\nVocê pode conseguir isto obtendo um Secreto. Conte o Secreto só ao seu amigo, e a mais ninguém. Quando o seu amigo digitar o seu Secreto na tela, vocês dois serão Amigos secretos em Toontown!'
FriendSecretGetSecret = 'Obter um secreto'
FriendSecretEnterSecret = 'Se você tiver um Secreto de alguém conhecido, digite-o aqui.'
FriendSecretOK = lOK
FriendSecretEnter = 'Inserir Secreto'
FriendSecretCancel = lCancel
FriendSecretGettingSecret = 'Obtendo Secreto. . .'
FriendSecretGotSecret = 'Este é o seu novo Secreto. Não deixe de anotá-lo em algum lugar!\n\nVocê só pode dar este Secreto a uma pessoa. Depois que alguém digitar o seu Secreto, ele não funcionará para nenhuma outra pessoa. Se você quiser dar um Secreto para mais de uma pessoa, obtenha outro.\n\nO Secreto só funcionará nos próximos dois dias. O seu amigo terá que digitá-lo antes que expire, caso contrário, não funcionará.\n\nO Secreto é:'
FriendSecretTooMany = 'Sinto muito, você não pode ter mais Secreto hoje. Você já obteve mais do que a parte que lhe cabia!\n\nTente novamente amanhã.'
FriendSecretTryingSecret = 'Tentando usar Secreto. . .'
FriendSecretEnteredSecretSuccess = 'Agora, você é Amigo secreto de %s!'
FriendSecretTimeOut = 'Sinto muitos, secretos não estão funcionando agora.'
FriendSecretEnteredSecretUnknown = 'Este Secreto não existe. Tem certeza de que digitou certo?\n\nSe você tiver digitado certo, ele pode ter expirado. Peça ao seu amigo para pegar outro Secreto para você (ou pegue um novo você mesmo e dê ao seu amigo).'
...
FriendSecretEnteredSecretSelf = 'Você acabou de digitar seu próprio Secreto! Agora, ninguém mais poderá usar este Secreto.'
...
FriendInviterCantSee = 'Isto só funciona se você puder ver %s.'
FriendInviterNotOnline = 'Isto só funciona se %s estiver online'
FriendInviterNotOpen = '%s não tem um bate-papo aberto, use secretos para fazer amigos'
...
SuitBrushOffs = {'f': ['Estou atrasado para uma reunião.'],
 'p': ['Sai fora.'],
 'ym': ['As vaquinhas de presépio dizem N\xc3\x83O.'],
...
SuitFaceoffTaunts = {'b': ['Você tem uma doação para mim?',
 ...
 'tbc': ['Cuidado, vou adoçar você.',
         ...
         'Tem certeza? \xc3\x80s vezes ajo como um Cãocadão.',
 ...
 'mh': ['Está preparado para a minha tomada?',
        'Luz, câmera, ação!',
        'Vai começar a rodar.',
        'Hoje o papel do Toon derrotado será feito por - VOC\xc3\x8a!',
 ...
 'mm': ['Vou entrar neste negócio.',
        '\xc3\x80s vezes, os piores venenos vêm em pequenos frascos.',
...
SpeedChatStaticText = {1: lYes,
 ...
 51001: 'Que um vento forte esteja às nossas costas, o sol em nossos rostos e nossos canhões disparem verdadeiramente!',
 ...
 50207: 'Falta um dobrão para completar o casco, companheiro!',
 50208: 'Cuidado com a língua ou vou picá-la com sal marinho!',
 50209: 'Toque-me, saque e você será chutado!',
 50210: 'O horizonte esteja tão vazio quanto sua cabeça.',
 50211: 'Você é uma tela com a vela cheia, não é, cara?',
 ...
 53102: 'Eu vi um Peixe Lendário!',
 53103: 'O que você pegou?',
 53104: 'Isso vai transformar uma história em uma baleia!',
 ...
 53111: 'Você já pegou um Peixe Lendário?',
 53112: 'Você consegue navegar em um barco de pesca?',
 53113: 'Onde está o Mestre da Pesca?',
 53114: 'Você completou sua coleção de peixes?',
 53120: 'Atire no meu alvo!',
 53121: 'Atirem no navio mais próximo da costa!',
 53122: 'Há um navio fugindo!',
 ...
 53145: 'Esta poção foi bastante fácil.',
 53146: 'ssa poção foi difícil de preparar, eu te digo!',
 53160: 'Precisamos de alguém para bombear o esgoto!',
 53161: 'Precisamos de alguém para esfregar!',
 53162: 'Precisamos de alguém para serrar!',
 53163: 'Precisamos de alguém para nos preparar!',
 53164: 'Precisamos de alguém para martelar!',
 53165: 'Precisamos de alguém para corrigir!',
 53166: 'Eu farei isso!',
 53167: 'Continue assim, este navio não vai se consertar sozinho!',
 53168: 'Ôtimo trabalho consertando o navio!',
