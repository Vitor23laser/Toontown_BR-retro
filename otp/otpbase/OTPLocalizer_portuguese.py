...
#2013 ActivateChat = """O recurso Amigos Secretos permite que um membro converse com outro membro apenas por meio de um código amigo secreto que deve ser comunicado fora do jogo. O recurso Amigos Secretos não é moderado ou supervisionado.
###Por favor, escolha uma das opções do recurso Amigos Secretos de Toontown:
#####\x01shadow\x01Sem O recurso Amigos Secretos\x02 - Capacidade para fazer o recurso Amigos Secretos é desativado.
   ##Isso oferece o mais alto nível de controle.
...
#2013-LeaveToSetParentPassword = """Para configurar a Senha da conta de pais, o jogo sairá para Toontown.com.br"""
