...
OpenChatWarning = 'Para se tornar Amigo verdadeiro de alguém, clique na pessoa e selecione "Amigos Verdadeiros" no painel de detalhes. É claro que você sempre poderá conversar com alguém pelo Chat rápido.\n\nChat Rápido Plus pode também ser ativado, que permite aos usuários conversar digitando palavras encontradas no dicionário Disney Chat Rápido Plus.\n\nPara ativar este recurso ou para aprender mais sobre ele, saia de Toontown e clique em "Opções da conta" na página da web de Toontown.'
...
UnpaidNoParentPasswordWarning = 'Isso é para o recurso Chat Rápido Plus, que permite aos usuários conversar digitando palavras encontradas no dicionário Disney Chat Rápido Plus. Para ativar este recurso ou para aprender mais sobre ele, saia de Toontown e clique em "Opções da conta" na página da web de Toontown.'
#UnpaidNoParentPasswordWarning = 'Depois de definir a senha de pais, você pode ativar este botão para conversar com seus amigos usando o teclado. Para definir a senha de pais, saia do Toontown e clique em "Preferências" em Serviços para membros na página do Toontown. Até lá, você deve conversar com outros Toons usando o Chat Rápido.'
...
#ChangeSecretFriendsOptionsWarning = "\nPor Favor insira a senha de pais para alterar suas opções de Amigos secretos."
ChangeSecretFriendsOptionsWarning = "\nPor Favor insira a senha da conta de pais para alterar suas opções de Amigos verdadeiros."
...
Ao ativar o recurso Amigos secretos, você reconhece que, apesar de haver alguns riscos inerentes a ele, você foi informado de todos os riscos mencionados aqui, concordando em aceitá-los, quaisquer desses riscos."""
