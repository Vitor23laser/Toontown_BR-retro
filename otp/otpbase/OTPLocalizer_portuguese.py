...
FriendSecretNeedsParentLoginWarning = 'Para conseguir ou digitar um Segredo, um dos seus pais ou responsáveis precisa fazer o login. Você pode desativar esta pergunta alterando suas opções de Amigos Verdadeiros.'
...
FriendSecretTooMany = 'Sinto muito, você não pode ter mais Segredo hoje. Você já obteve mais do que a parte que lhe cabia!\n\nTente novamente amanhã.'
