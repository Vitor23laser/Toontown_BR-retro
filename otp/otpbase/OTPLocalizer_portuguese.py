...
WhisperComingOnline = '%s está entrando on-line!'
WhisperLoggedOut = '%s fez logout.'
...
OpenChatWarning = 'Para se tornar Amigo secreto de alguém, clique na pessoa e selecione "Amigos secretos" no painel de detalhes.\n\nO recurso Chat rápido Plus pode também estar ativado, qual permite usários para bater um papo por digitando palavras encontrado no Dicionário Chat Rápido Plus.\n\nPara ativar qualquer um desses recursos ou para saber mais sobre eles, saia do Toontown e clique em "Preferências" em Serviços para Membros no site do Toontown.'
...
PaidNoParentPasswordWarning = 'Use este botão para conversar com seus amigos usando o teclado, ative-o através das suas Opções de Contas no site de Toontown. Até lá, você pode conversar por usando o Chat rápido '
UnpaidNoParentPasswordWarning = 'Este é para o recurso Chat Rápido Plus, qual permite usários para bater um papo por digitando palavras encontradas no Dicionário Chat Rápido Plus da Disney. Para ativar qualquer um desses recursos ou para saber mais sobre eles, saia do Toontown e clique em "Preferências" em Serviços para Membros no site do Toontown.'
...
RestrictedSecretChatWarning = 'Para pegar ou digitar um código de amigo secreto, faça login com a conta de pais. Você pode desativar esta solicitação alterando as suas opções de Amigos secretos.'
...
NoSecretChatAtAll = 'O recurso Abrir Chat com Amigos secretos permite amigos da vida-real para conversar abertamente com uns aos outros por meio de um código de amigo secreto que deve ser compartilhado fora do jogo\n\nPara ativar qualquer um desses recursos ou para saber mais sobre eles, saia do Toontown e clique em "Preferências" em Serviços para Membros no site do Toontown.'
NoSecretChatAtAllAndNoWhitelistTitle = 'Botão de Chat'
NoSecretChatAtAllAndNoWhitelist = 'Você pode usar o botão azul de chat para se comunicar com outros Toons usando o recurso Chat Rápido Plus ou o recurso Abrir Chat com Amigos secretos.\n\nO recurso Chat rápido Plus é uma forma de tipo de chat que permitem usuários para comunicarem por usar o dicionário Disney Chat Rápido Plus.\n\nO recurso Abrir Chat com Amigos secretos é uma forma de tipo de chat que permite amigos da vida-real para conversar abertamente com uns aos outros por meio de um código de amigo secreto que deve ser compartilhado fora do jogo.\n\nPara ativar qualquer um desses recursos ou para saber mais sobre eles, saia do Toontown e clique em "Preferências" em Serviços para Membros no site do Toontown.'
NoSecretChatAtAllOK = lOK
ChangeSecretsOptions = 'Alterar opções de Amigos secretos'
ChangeSecretsOptionsWarning = '\nInsira a Senha de pais para alterar suas opções de Amigos secretos.'
...
SecretNeedsPasswordWarningTitle = 'Controles disponíveis aos pais'
SecretNeedsParentLoginWarning = 'Para conseguir ou digitar um Código de Amigo secreto, um dos seus pais ou responsáveis precisa fazer o login. Você pode desativar esta pergunta alterando suas opções de Amigos secretos.'
SecretNeedsPasswordWarning = 'Para pegar ou digitar um código de amigo secreto, você deve inserir a Senha de pais. Você pode desativar esta solicitação alterando as suas opções de Amigos verdadadeiros.'
SecretNeedsPasswordWarningOK = lOK
SecretNeedsPasswordWarningCancel = lCancel
SecretNeedsPasswordWarningWrongUsername = 'Esse não é o nome de usuário correto. Digite o nome de usuário da conta de pais. Esse não é o mesmo nome de usuário que é usado para jogar.'''
SecretNeedsPasswordWarningWrongPassword = 'Esta não é a senha correta. Insira a Senha de pais criada na compra desta conta. Não é a mesma senha usada para os jogos.'''
SecretIntro = 'Se você estiver jogando Toontown Online da Disney com alguém que conhece no mundo real, poderá tornar-se Amigo secreto dessa pessoa. Você pode conversar com seus Amigos secretos usando o teclado. Os outros Toons não entenderão o que vocês estiverem falando.\n\nVocê pode conseguir isto obtendo um código de amigo secreto. Conte o código de amigo secreto só ao seu amigo, e a mais ninguém. Quando o seu amigo digitar o seu código de amigo secreto na tela, vocês dois serão Amigos secretos em Toontown!'
SecretGetSecret = 'Obter um código de amigo secreto'
SecretEnterSecret = 'Se você tiver um código de amigo secreto de alguém conhecido, digite-o aqui.'
SecretOK = lOK
SecretEnter = 'Inserir código de amigo secreto'
SecretCancel = lCancel
SecretGettingSecret = 'Obtendo código de amigo secreto. . .'
SecretGotSecret = 'Este é o seu novo código de amigo secreto. Não deixe de anotá-lo em algum lugar!\n\nVocê só pode dar este código de amigo secreto a uma pessoa. Depois que alguém digitar o seu código de amigo secreto, ele não funcionará para nenhuma outra pessoa. Se você quiser dar um código de amigo secreto para mais de uma pessoa, obtenha outro.\n\nO código de amigo secreto só funcionará nos próximos dois dias. O seu amigo terá que digitá-lo antes que expire, caso contrário, não funcionará.\n\nO código de amigo secreto é:'
SecretTooMany = 'Sinto muito, você não pode ter mais código de amigo secreto hoje. Você já obteve mais do que a parte que lhe cabia!\n\nTente novamente amanhã.'
SecretTryingSecret = 'Tentando usar código de amigo secreto. . .'
SecretEnteredSecretSuccess = 'Agora, você é Amigo secreto de %s!'
FriendSecretTimeOut = 'Sinto muitos, segredos não estão funcionando agora.'
FriendSecretEnteredSecretUnknown = 'Este código de amigo secreto não existe. Tem certeza de que digitou certo?\n\nSe você tiver digitado certo, ele pode ter expirado. Peça ao seu amigo para pegar outro código de amigo secreto para você (ou pegue um novo você mesmo e dê ao seu amigo).'
...
FriendSecretEnteredSecretWrongProduct = 'Você digitou o tipo errado de Código de Amigo secreto.\nEste jogo utiliza códigos que começam com '%s'.'
...
FriendInviterToonTooMany = 'Você tem amigos Toons demais em sua lista para poder acrescentar um agora. Remova alguns amigos Tonns se quiser fazer amizade com %s.'
...
FriendInviterNotOpen = '%s não tem um bate-papo aberto, use amigos secretos para fazer amigos'
...
EmoteFuncDict = {'Wave': 0,
 ...
 'Sing Note F': 31,
 'Sing Note G2': 32}
SuitBrushOffs = {'f': ['Estou atrasado para uma reunião.'],
 'p': ['Sai fora.'],
