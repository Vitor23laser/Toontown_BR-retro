...
FriendSecretNeedsPasswordWarning = 'Para pegar ou digitar um Código de Amigos Secretos, você deve inserir a Senha conta de pais. Você pode desativar esta solicitação alterando as suas opções de Amigos verdadadeiros.'
