...
ActivateChat = """O recurso Amigos verdadeiros permite que um membro converse com outro membro apenas por meio de um código de amigo verdadeiro que deve ser comunicado fora do jogo. O recurso Amigos verdadeiros não é moderado ou supervisionado.
