...
RestrictedSecretChatWarning = 'Para pegar ou digitar um Segredo, faça login com a conta de pais. Você pode desativar esta solicitação alterando as suas opções de Amigos secretos.'
...
ActivateChat = """O recurso Amigos secretos permite que um membro converse com outro membro apenas por meio de um código amigo verdadeiro que deve ser comunicado fora do jogo. O recurso Amigos secretos não é moderado ou supervisionado.
...
AvatarPanelSecrets = "Amigios secretos"
