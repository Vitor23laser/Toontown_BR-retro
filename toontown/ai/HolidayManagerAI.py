...
OriginalHolidays = {
    ...
    { 'startAndEndPairs' : [datetime.datetime( 2010, Month.JUNE, 11, 13, 30),
                                     datetime.datetime( 2010, Month.JUNE, 11, 17, 30), ],
    },
    ...
    { 'startAndEndPairs' : [datetime.datetime( 2010, Month.FEBRUARY, 14, 2, 00),
                                     datetime.datetime( 2010, Month.FEBRUARY, 14, 6, 00),
                                     
                                     datetime.datetime( 2010, Month.FEBRUARY, 14, 10, 00),
                                     datetime.datetime( 2010, Month.FEBRUARY, 14, 14, 00),
                                     
                                     datetime.datetime( 2010, Month.FEBRUARY, 14, 18, 00),
                                     datetime.datetime( 2010, Month.FEBRUARY, 14, 22, 00),],
    },    
    
    ToontownGlobals.YES_MAN_INVASION:    
    { 'startAndEndPairs' : [datetime.datetime( 2010, Month.DECEMBER, 20, 2, 00),
                                     datetime.datetime( 2010, Month.DECEMBER, 20, 6, 00),
                                     
                                     datetime.datetime( 2010, Month.DECEMBER, 20, 10, 00),
                                     datetime.datetime( 2010, Month.DECEMBER, 20, 14, 00),

                                     datetime.datetime( 2010, Month.DECEMBER, 20, 18, 00),
                                     datetime.datetime( 2010, Month.DECEMBER, 20, 22, 00),],
    },
    ...
    { 'startAndEndPairs' : [datetime.datetime( 2010, Month.NOVEMBER, 17, 9, 00),
                                     datetime.datetime( 2010, Month.NOVEMBER, 17, 14, 00),
                                     
                                     datetime.datetime( 2010, Month.NOVEMBER, 17, 19, 00),
                                     datetime.datetime( 2010, Month.NOVEMBER, 17, 23, 59),

                                     datetime.datetime( 2010, Month.NOVEMBER, 18, 5, 00),
                                     datetime.datetime( 2010, Month.NOVEMBER, 18, 10, 00),],    
    },
    ...
    { 'startAndEndPairs' : [datetime.datetime( 2010, Month.SEPTEMBER, 8, 7, 00),
                                     datetime.datetime( 2010, Month.SEPTEMBER, 8, 10, 00),
                                     
                                     datetime.datetime( 2010, Month.SEPTEMBER, 8, 13, 00),
                                     datetime.datetime( 2010, Month.SEPTEMBER, 8, 16, 00),

                                     datetime.datetime( 2010, Month.SEPTEMBER, 8, 19, 00),
                                     datetime.datetime( 2010, Month.SEPTEMBER, 8, 22, 00),],    
    },
    
    ToontownGlobals.MINGLER_INVASION: 
    { 'startAndEndPairs' : [datetime.datetime( 2010, Month.APRIL, 3, 2, 00),
                                     datetime.datetime( 2010, Month.APRIL, 3, 4, 59),
                                     
                                     datetime.datetime( 2010, Month.APRIL, 3, 10, 00),
                                     datetime.datetime( 2010, Month.APRIL, 3, 12, 59),

                                     datetime.datetime( 2010, Month.APRIL, 3, 18, 00),
                                     datetime.datetime( 2010, Month.APRIL, 3, 20, 59),],    
    },
    ...
    ToontownGlobals.MR_HOLLYWOOD_INVASION:
    { 'startAndEndPairs' : [datetime.datetime( 2010, Month.FEBRUARY, 27, 0, 00),
                                     datetime.datetime( 2010, Month.FEBRUARY, 27, 2, 00),
                                     
                                     datetime.datetime( 2010, Month.FEBRUARY, 27, 8, 00),
                                     datetime.datetime( 2010, Month.FEBRUARY, 27, 10, 00),

                                     datetime.datetime( 2010, Month.FEBRUARY, 27, 16, 00),
                                     datetime.datetime( 2010, Month.FEBRUARY, 27, 18, 00),],    
    },    
    
    ToontownGlobals.ROBBER_BARON_INVASION:
    { 'startAndEndPairs' : [datetime.datetime( 2010, Month.SEPTEMBER, 27, 2, 01),
                                     datetime.datetime( 2010, Month.SEPTEMBER, 27, 4, 00),
                                     
                                     datetime.datetime( 2010, Month.SEPTEMBER, 27, 10, 01),
                                     datetime.datetime( 2010, Month.SEPTEMBER, 27, 12, 00),

                                     datetime.datetime( 2010, Month.SEPTEMBER, 27, 18, 01),
                                     datetime.datetime( 2010, Month.SEPTEMBER, 27, 20, 00),],    
    },    
    
    ToontownGlobals.BIG_WIG_INVASION:
    { 'startAndEndPairs' : [datetime.datetime( 2010, Month.JULY, 27, 4, 01),
                                     datetime.datetime( 2010, Month.JULY, 27, 6, 00),
                                     
                                     datetime.datetime( 2010, Month.JULY, 27, 12, 01),
                                     datetime.datetime( 2010, Month.JULY, 27, 14, 00),

                                     datetime.datetime( 2010, Month.JULY, 27, 20, 01),
                                     datetime.datetime( 2010, Month.JULY, 27, 22, 00),],    
    },    
    
    ToontownGlobals.BIG_CHEESE_INVASION:
    { 'startAndEndPairs' : [datetime.datetime( 2010, Month.OCTOBER, 26, 6, 01),
                                     datetime.datetime( 2010, Month.OCTOBER, 26, 8, 00),
                                     
                                     datetime.datetime( 2010, Month.OCTOBER, 26, 14, 01),
                                     datetime.datetime( 2010, Month.OCTOBER, 26, 16, 00),

                                     datetime.datetime( 2010, Month.OCTOBER, 26, 22, 01),
                                     datetime.datetime( 2010, Month.OCTOBER, 26, 23, 59),],    
    },    
    
    ToontownGlobals.HYDRANTS_BUFF_BATTLES: 
    { 'startAndEndPairs':    [datetime.datetime( 2010, Month.JUNE,   6,  12, 01), # they just animate but don't help
                                        datetime.datetime( 2031, Month.JUNE,   7,   3,  0),],
      'phaseDates': [datetime.datetime( 2010, Month.JUNE,   8,   3,  0),], # they're actually helping now
    },

    ToontownGlobals.MAILBOXES_BUFF_BATTLES: 
    { 'startAndEndPairs':       [datetime.datetime( 2010, Month.JUNE,   14,  12, 01), # they just animate but don't help
                                           datetime.datetime( 2031, Month.JUNE,  15,   3,  0),], #forever, impressive if we hit this!
      'phaseDates': [datetime.datetime( 2010, Month.JUNE,  16,   00,  01),], # they're actually helping now      
    },

    ToontownGlobals.TRASHCANS_BUFF_BATTLES: 
    { 'startAndEndPairs':       [datetime.datetime( 2010, Month.JULY,   16,  12, 01), # they just animate but don't help
                                          datetime.datetime( 2031, Month.JUNE,  17,   3,  0), ], #forever, impressive if we hit this!
...
#        ),
        ...
        ToontownGlobals.BLACK_CAT_DAY: HolidayInfo_Yearly(BlackCatHolidayMgrAI.BlackCatHolidayMgrAI,
        ...
        [(2029, Month.JANUARY, 8,  10, 0, 0),
         (2029, Month.JANUARY, 8,  23, 59, 59)],
        displayOnCalendar = False,
        ),
