...
GlobalStreetNames = {
    ...
    2300  : ("para a",  "na", "Alameda da Piada"),
    3000  : ("para o",  "no", "Parque"),
    3100  : ("para a",  "na", "Via das Morsas"),
    ...
    9200  : ("para a",  "na", "Alemada do Pijama"),
...
FactoryNames = {
    ...
    13300 : 'Escritório do Cog  '+Lawbot, #remove me JML
    }
...
QuestDialogDict = {
  ...
  #163 : {GREETING : "",
    ...
    3242 : { QUEST : "Ah não! Um Cog Águia legal roubou a Chave para os Jardins da Margarida!\aVeja se você consegue recuperá-la.\aLembre-se, os Macacos-velhos só podem ser encontrados dentro dos edifícios de Robôs da Lei." },
    3243 : { QUEST : "Você achou uma chave, tudo bem, mas esta não é a correta!\aPrecisamos da chave dos Jardins da Margarida.\aContinue de olho! Ela ainda está com algum Cog Águia legal!" },

    3240 : { QUEST : "Acabei de saber que um Águia legal roubou um saco de ração para pássaros de _toNpcName_ .\aDerrote Macacos velhos até recuperar a ração para pássaros do Florêncio e levá-la de volta para ele.\aOs Macacos velhos só são encontrados dentro de edifícios de Robôs da Lei._where_",
    ...
    5311 : { GREETING : "O QUEEE!!!!",
             ...
             QUEST : "Álibi?! Mas que ótima ideia!\aE traga duas!\aAposto que um Águia legal deve ter alguns..."  },
...
SuitLegalEagleS = "um Águia legal"
...
ForcedLeaveFactoryAckMsg = "O" + Foreman + " foi derrotado antes de você alcançá-lo. Você não recuperou nenhuma parte do Cog."
...
TutorialHQOfficerName = "Harry do Quartel"
...
WinterCarolingStart = "Canções de natal chegou para Toontown. Cante para sua Cabeça de Boneco de Neve - veja o Blog para mais detalhes!"
...
CogdoFlyingGameTitle = "Escritórios da Águia legal"
...
CogdoFlyingGameLegalEagleTargeting = "Uma Águia legal tem percebido vocês!"
CogdoFlyingGameLegalEagleAttacking = "Ataque da Águia!"
