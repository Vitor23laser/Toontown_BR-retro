...
QuestDialogDict = {160: {GREETING: '',
 ...
 1055: {QUEST: 'Oiááá! Eu não consigo encontrar os pneus para este carro de palhaço em lugar nenhum!\x07Você acha que pode me ajudar?\x07Eu acho que o Tito Tonto pode ter jogado os pneus no lago do pátio do Centro de Toontown.\x07Se você ficar em um dos cais de lá, poderá tentar pescar os pneus para mim.',
        GREETING: 'Iuhuu!',
        LEAVING: '',
 ...
 1061: {QUEST: 'Ótimo, valeu pela tinta!\x07Sabe de uma coisa, se você eliminasse alguns daqueles Ratos de Escritório...\x07Aí minha tinta não acabaria tão rápido.\x07Derrote 6 Ratos de Escritório no Centro de Toontown para receber sua recompensa.',
        LEAVING: '',
        COMPLETE: 'Valeu! Vou recompensar você pela sua ajuda.',
        INCOMPLETE_PROGRESS: 'Eu acabei de ver mais alguns Ratos de Escritório.'},
 1062: {QUEST: 'Ótimo, valeu pela tinta!\x07Sabe de uma coisa? Se você eliminasse alguns daqueles Sanguessugas...\x07Aí minha tinta não acabaria tão rápido.\x07Derrote 6 Sanguessugas no Centro de Toontown para receber sua recompensa.',
        LEAVING: '',
        COMPLETE: 'Valeu! Vou recompensar você pela sua ajuda.',
 ...
 1067: {QUEST: 'É ele mesmo, está tudo certo!\x07Ei, o endereço está borrado...\x07Tudo o que eu posso ler é que é para um Dr. - o resto está ilegível.\x07Talvez seja para _toNpcName_? Você pode levar para ele?_where_',
        LEAVING: ''},
 1068: {QUEST: 'Eu não estava esperando um pacote. Talvez seja para o Dr. E.U. Fórico.\x07Meu assistente ia passar mesmo lá hoje, então pedirei a ele que verifique para você.\x07Nesse meio tempo, você se importaria de se livrar de alguns dos Cogs que estão na minha rua?\x07Derrote 10 Cogs no Centro de Toontown.',
        LEAVING: '',
 ...
 3235: {QUEST: 'Ah, esta é a salada que pedi!\x07Obrigada por trazê-la para mim.\x07Todos esses Cogs devem ter amedrontado novamente o entregador de _toNpcName_ .\x07Por que você não nos faz um favor e derrota alguns desses Cogs lá fora?\x07Derrote 10 Cogs nos Jardins da Margarida e, então, vá até _toNpcName_.',
 ...
 3238: {QUEST: 'Ah não! Um Cog "Amizade Fácil" roubou a Chave para os Jardins da Margarida!\x07Veja se você consegue recuperá-la.\x07Lembre-se, o Amizade Fácil só pode ser encontrado dentro dos edifícios de Robôs Vendedores.'},
 3239: {QUEST: 'Você achou uma chave, tudo bem, mas esta não é a correta!\x07Precisamos da chave dos Jardins da Margarida.\x07Continue de olho! Ela ainda está com algum Cog "Amizade Fácil"!'},	
 3242: {QUEST: 'Ah não! Um Cog Macaco velho roubou a Chave para os Jardins da Margarida!\x07Veja se você consegue recuperá-la.\x07Lembre-se, os Macacos-velhos só podem ser encontrados dentro dos edifícios de Robôs da Lei.'},
 3243: {QUEST: 'Você achou uma chave, tudo bem, mas esta não é a correta!\x07Precisamos da chave dos Jardins da Margarida.\x07Continue de olho! Ela ainda está com algum Cog Macaco velho!'},
 ...
 3255: {QUEST: '_toNpcName_ está investigando o ' + lSellbotHQ + '.\x07Veja se você consegue ajudar._where_'},
 3256: {QUEST: '_toNpcName_ está investigando o ' + lSellbotHQ + '.\x07Veja se você consegue ajudar._where_'},
 3257: {QUEST: '_toNpcName_ está investigando o ' + lSellbotHQ + '.\x07Veja se você consegue ajudar._where_'},
...
CogdoBattleBldgBossTaunt = 'Eu não aceito reuniões com Toons.'
...
toontownDialogues = {BoringTopic: {(1, 2018): ['Oi Albert', 'Parece que o nível de bobagem está subindo', 'Sim, e se não esqueça dos Toons de Abril!'],
 ...
 EmceeDialoguePhase1Topic: {(1, 2020): ['Companheiros Toons, este é o Medidor de Bobagens!',
                                        "Ele está monitorando os níveis de Bobagens crescentes de Toontown...",
                                        'Que estão fazendo com que objetos na rua sejam animados!',
                                        'E VOCÊ pode ajudar a elevar esses níveis!',
                                        'Batalha de Cogs para causar Surtos de Bobagens...',
                                        'Deixar Toontown mais boba do que nunca...',
                                        "E vamos ver o mundo ganhar vida!",
                                        "Agora vou repetir o que eu disse, mas só mais uma vez."]},
...
NewsPageDownloadingNewsSubstr = 'Fique Tooned, enquanto trazemos a você a última edi\xc3\x07aão do \n"Notícias dos Toons... para os divertidos!"'
