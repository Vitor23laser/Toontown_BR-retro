...
QuestsDefaultVisitQuestDialog = ("Ouvi falar que _toNpcName_ está procurando por você._where_", 
 ...
 "Se tiver um tempinho, pare e diga olá para _toNpcName_._where_", "_toNpcName_ dará a você sua nova Tarefa Toon._where_")
...
QuestDialog_3225 = {QUEST: "Puxa, obrigado por vir, _avName_!\aOs Cogs que estão no bairro assustaram o rapaz que faz as entregas.\aEu não tenho quem entregue esta salada para _toNpcName_!\aVocê poderia fazer isso por mim? Muitíssimo obrigado!_where_"}
QuestDialog_2910 = {QUEST: "De volta tão rápido assim?\aÓtimo trabalho com aquela mola.\aO último item é um contrapeso.\aPasse lá, veja com _toNpcName_ e traga o que você conseguir._where_"}
QuestDialogDict = {160: {GREETING: "",
       QUEST: "Ok, agora acho que você está pronto para um desafio maior.\aDerrote 3 Robôs-chefes.",
 ...
 162: {GREETING: "",
       ...
       LEAVING: QuestsDefaultLeaving},
 163: {GREETING: "",
       QUEST: "Ok, agora acho que você está pronto para um desafio maior.\aDetorre 3 Robôs Vendedores.",
...
TipDict = {TIP_NONE : (
    ...
    # "Você pode trocar segredos com alguém conhecido que não seja de Toontown, para permitir um bate-papo aberto com essa pessoa em Toontown.",
