...
QuestsDefaultReject = ('Hello.',
 ...
 "To show Secretss what you're thinking, enter a '.' before your thought.",
...
TeaserSecretChat = 'To use the Secretss Chat feature'
...
TipDict = {TIP_NONE: ('',),
 TIP_GENERAL: ('Quickly check your ToonTask progress by holding down the "End" key.',
               ...
               'The names of your Secretss will appear in Blue.',
