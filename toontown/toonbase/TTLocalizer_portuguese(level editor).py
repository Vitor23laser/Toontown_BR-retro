...
GlobalStreetNames = {
    ...
    10000 : ("para o",  "no", "Clube de Campo do Robô-chefe"),
    ...
    12000 : ("para o",  "no", "Pátio de trens do Quartel do Robô Mercenário"),
...
WinterPlutoCChatter = (
        ...
        [ # Comments
        "Rogério Gélido adoraria uma canção, pois a Terra do Homem de Neve é um lugar solitário para um pé-grande.",
...
AFMickeyChatter = (
        ...
        [ # Goodbyes
        "Tenha uma Semana Louca dos Toons de Abril!",
        "Fala com Mickey que eu diz Oi!",
        ]
    )
...
AFMinnieChatter = (
        ...
        [ # Goodbyes
        "Tenha uma Semana Louca dos Toons de Abril!",
        "Eu preciso para trabalhar no meu kart! Tchau!",
        ]
    )
...
AFDonaldDockChatter = (
        ...
        [ # Comments
        "Todo mundo folga na Semana dos Toons de Abril, menos eu!",
        ...
        [ # Goodbyes
        "Tenha uma Louca Semana dos Toons de Abril!",
...
AFPlutoChatter = (
        ...
        [ # Goodbyes
        "Tenha uma Louca Semana Toons de Abril!",
...
HolidayNamesInCalendar = {
   ...
   29: ("Semana Toons de Abril", "Comemore o Semana Toons de Abril - um feriado construido por Toons para Toons!"),
