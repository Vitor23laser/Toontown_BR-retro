...
GlobalStreetNames = {
    ...
    12000 : ("para o", "no", "Pátio de Trem do "+lCashbotHQ),
...
FactoryNames = {
    ...
    13300 : 'Escritório de Cog Robô da Lei', #remove me JML
    }
...
QuestDialogDict = {
    ...
    # Abrão the will give you laff point for helping him
...
ToonHealJokes = [
    ...
    ["O que é um pontinho amarelo no céu?",
     "Um yellowcóptero."],
    ["O que o " + MickeyMouse + " foi fazer no espaço?",
     "Ele foi procurar o " + Pluto + "."],
    ]
...
Cogdominiums = Cogs.upper() + CogdominiumsExt
...
FADoorCodes_BB_DISGUISE_INCOMPLETE = "Você vai ser pego se entrar lá como um Toon! Você precisa completar o seu Disfarce de Robô Chefe primeitro!\n\nMonte o seu Disfarce de Robô Chefe cumprindo as Tarefas Toon depois da Sonholândia do Donald."
...
ValentinesMickeyChatter = (
    [
    "Olá, eu sou o Mickey!",
    "Bem-vindo à Toons dos Namorados!",
    "Feliz Toons dos Namorados!",
    "Feliz Toons dos Namorados, %",
    ],
    [
    ...
    "O Cattlelog tem vários presentes para o Toons dos Namorados!",
    "Dê uma festa Toons dos Namorados!",
...
VampireMickeyChatter = (
        ...
        [ # Comments
        "Se você acha que fazer travessuras é Diversões e Jogos, visite Ralf Desocupado, na Só Diversão, para ganhar uma gostosura!",
...
WinterMinnieCChatter = (
        ...
        [ # Comments
        "Você vai ganhar muito mais do que um Barbearia Musical para Bárbara Sevilha na Um Penteado por Uma Canção!",
        "Solte a voz, Toon!",
        "Você vai ganhar muito mais do que um Barbearia Musical para Bárbara Sevilha na Um Penteado por Uma Canção!",
...
ValentinesMinnieChatter = (
    ...
    "Eu quero ir a uma festa dos Toons dos Namorados!",
    "Espero que o Mickey me leve ao Café Levado!",
    "Mickey é um ótimo Toon Namorado!",
    "O que você trouxe para seu Toons dos Namorados ",
    "O Mickey nunca perdeu um Dia dos Toons dos Namorados!",
    ],
    [
    "Espalhe o amor!",
    "Adorei sua visita!",
...
WitchMinnieChatter = (
        [ # Greetings
        "Bem-vindo a uma terra mágica... ou melhor, à Melodilândia!",
        ...
        [ # Comments
        "Ouvi dizer que Tábata tem doces para aqueles que sabem fazer travessuras para Realmente Felinos Felizes!",
        "É um dia mágico, não acha?",
        "Ouvi dizer que Tábata tem doces para aqueles que sabem fazer travessuras para Realmente Felinos Felizes!",
        "Onde eu coloquei meu livro de feitiços?",
        "Ouvi dizer que Tábata tem doces para aqueles que sabem fazer travessuras para Realmente Felinos Felizes!",
        "Abracadabra!",
        "Ouvi dizer que Tábata tem doces para aqueles que sabem fazer travessuras para Realmente Felinos Felizes!",
        ...
        "Mickey vai me levar para dizer Doces-ou-Travessuras!",
        ]
    )
...
ValentinesDaisyChatter = (
    ...
    [
    "Espero que o Donald não me traga outra Enguia Amore!",
    "O Donald está me levando ao 'Deep-Sea'!",
    "Com certeza, eu tenho rosas suficientes!",
    "Aqueles corações são bons para melhorar a Risada!",
    "Eu adoraria ir a uma festa Dia dos Toons dos Namorados!",
    "Este é um jardim onde o amor cresce!",
    "É bom que o Donald não durma novamente no Dia dos Toons dos Namorados!",
...
WinterDaisyCChatter = (
        ...
        "Suzana, da Artesanato Pínus, adora música, então por que não compor uma canção de Natal para ela?",
        "Essas luzes nos abajures são lindas!",
        "Suzana, da Artesanato Pínus, adora música, então por que não compor uma canção de Natal para ela?",
        "Que azevinho alegre!",
        "Suzana, da Artesanato Pínus, adora música, então por que não compor uma canção de Natal para ela?",
        "Meu boneco de neve continua derretendo!",
        "Suzana, da Artesanato Pínus, adora música, então por que não compor uma canção de Natal para ela?",
        "Esse pato está enfeitado!",
        "Suzana, da Artesanato Pínus, adora música, então por que não compor uma canção de Natal para ela?",
        "Eu mesma plantei todas essas luzes!",
        ],
        [ # Goodbyes
        "Tenham um ótimo feriado de inverno!",
        "Feliz plantio!",
        "Diga ao Donald para passar aqui com os presentes!",
        "O Donald vai me levar para cantar canções de natal!",
        ]
    )
...
HalloweenDaisyChatter = (
        ...
        [ # Comments
        "Visite meu amigo J. Jardim se você ter uma travessura e Pousada Coisa vai dar os doces!",
        "Quer dançar?",
        "Visite meu amigo J. Jardim se você ter uma travessura e Pousada Coisa vai dar os doces!",
        ...
        [ # Goodbyes
        "Donald vai me levar para dizer Doces-ou-Travessuras!",
...
WinterChipChatter = (
        ...
        "Você comprou um presente para os Cogs?",
        ],
        [ # Goodbyes
...
HalloweenChipChatter = (
        ...
        [ # Comments
        "Estamos loucos por Halloween!",
        "Sou o Teco vestido de Tico.",
...
ValentinesDaleChatter = (
    ...
    [ # Comments
    "Mesma coisa do ano passado. Nada!",
    "Eu perdi as nozes!",
...
WinterDaleChatter = (
        ...
        "Sim, uma torta de creme!",
        ],
        [ # Goodbyes
        "E tragam um pouco para nós!",
        "Tenham um ótimo feriado de inverno!",
        ]
    )
...
HalloweenDaleChatter = (
        ...
        "Espero que você esteja curtindo nossa diversão de Halloween!",
        "Estamos loucos por Halloween!",
        "Sou o Tico vestido de Teco.",
        "Jogue golfe e ganhe um Uivo-Em-Um.",
        "Milho doce é mais doce que bolota.",
        ],
        [ # Goodbyes
        "%, tome cuidado com os Cogs Sanguessugas!"
        ]
    )
...
ValentinesGoofyChatter = (
    [
    "Eu sou o Pateta e estou animado para o Dia dos Toons dos Namorados!",
    "Feliz Dia dos Toons dos namorados!",
    "Feliz Dia dos Toons dos namorados, %!",
    ],
    [
    "Nossa! Já é o Dia dos Toons dos namorados?",
...
SuperGoofyChatter = (
        [ # Greetings
        "Bem-vindo ao meu Super Autódromo!",
        "Oi, eu sou o Super Pateta! Qual é o seu nome?",
        "Feliz Dia das Bruxas!",
        "Feliz Dia das Bruxas, %!",
        ],
        [ # Comments
        "Estou me sentindo meio maluco hoje!",
        "Alguém viu minha capa por aí? Ah, lá está ela!",
        "Nossa! Eu não conheço minha própria força!",
        "Alguém chamou um super-herói?",
        "Cuidado, Cogs, eu vou salvar o Halloween!",
        "Não há nada mais assustador do que eu em um kart!",
        "Aposto que você não sabe quem eu sou com esta máscara!", 
        "É divertido se fantasiar para o Halloween!",
        "Espero que você esteja curtindo nossa diversão de Halloween!",
        ],
        [ # Goodbyes
        "Preciso voar!",
        "Oi-ho e lá vou eu!",
        "Devo voar ou dirigir até o Porto do Donald?",
        "Nossa, tenha um Feliz Dia das Bruxas!",
        ]
    )
...
WinterDreamlandCChatter = (
        [ # Greetings
        "Oi, eu sou o Donald Cochilando!",
        "Bem-vindo ao Feriado da Sonholândia!",
        "Feliz Feriado de Inverno!",
        "Feliz Feriado de Inverno, %!",
        ],
        [ # Comments
        "Samuel diz que aprender um pouco de Treinamento de Voz Dormindo é um presente de verdade, cante uma música para ela e descubra o porquê!",
        "Eu queria estar bem aconchegado na minha cama!",
        "Samuel diz que aprender um pouco de Treinamento de Voz Dormindo é um presente de verdade, cante uma música para ela e descubra o porquê!",
        "Estou sonhando com Toontown branca!",
        "Samuel diz que aprender um pouco de Treinamento de Voz Dormindo é um presente de verdade, cante uma música para ela e descubra o porquê!",
        "Eu queria deixar leite e biscoitos para fora!",
        "Samuel diz que aprender um pouco de Treinamento de Voz Dormindo é um presente de verdade, cante uma música para ela e descubra o porquê!",
        "Quando eu acordar, é melhor eu ver muitos presentes!",
        "Samuel diz que aprender um pouco de Treinamento de Voz Dormindo  é Um presente de verdade, cante uma música para ela e descubra o porquê!",
        "Espero não dormir durante as férias!",
        "Samuel diz que aprender um pequeno Treinamento de Voz Dormindo é um presente de verdade, cante uma música para ela e descubra o porquê!",
        "Eu adoro uma longa soneca de inverno!",
        "Samuel diz que aprender um pouco de Treinamento de Voz Dormindo é um presente de verdade, cante uma música para ela e descubra o porquê!",
        "As árvores nas ruas estão cobertas de luzes noturnas!",
        ],
        [ # Goodbyes
...
HalloweenDreamlandChatter = (
       ...
       [ # Comments
       "Se você conseguir pregar uma travessura no meu amigo Máximo, poderá Relaxar ao Máximo com um doce!",
       "Meus sonhos estão realmente assustadores esta noite!",
       "Se você conseguir pregar uma travessura no meu amigo Máximo, poderá Relaxar ao Máximo com um doce!",
       "Devo estar sonhando, aquela luminária é uma bruxa!",
       "Se você conseguir pregar uma travessura no meu amigo Máximo, poderá Relaxar ao Máximo com um doce!",
       "Estou sonhando ou aquele desenho animado tinha uma cabeça de abóbora?", 
       "Se você conseguir pregar uma travessura no meu amigo Máximo, poderá Relaxar ao Máximo com um doce!",
       "Quando eu acordar, espero que as coisas não sejam tão assustadoras!",
       "Se você conseguir pregar uma travessura no meu amigo Máximo, poderá Relaxar ao Máximo com um doce!",
       "Espero não dormir durante o Halloween!",
       "Se Você pode pregar uma travessura no meu amigo Máximo e Relaxar ao Máximo com um doce!",
       "Espero que esteja curtindo nossa diversão de Halloween!",
       ],
       [ # Goodbyes
       "Durma com as luzes acesas hoje à noite!",
       "Quando eu acordar, vou pedir doces!",
       ]
    )

ValentinesDreamlandChatteter = (
    [
    "Olá, eu sou o (bocejo) Donald!",
    "Feliz Dia dos Toons dos Namorados!",
    "Feliz Dia dos Toons dos Namorados, %!",
    ],
    [
    "Espero não dormir durante o Dia dos Toons dos Namorados!",
    "Estou sonhando com a Margarida!",
    "Tive um pesadelo que perdi o Dia dos Toons dos Namorados!",
    "Esses corações são bons para aumentar as risadas!",
    "Faça uma festa de Dia dos Toons dos Namorados!",
    "Mostre aos Cogs que você os ama com uma torta na cara!",
    "Eu nem sonharia com uma Férias melhores que o Dia do ValenToon!",
    "Eu adoro dormir!", 
    ],
    [
    "Noite-noite!",
    "Me acorde quando for o Dia dos Toons dos Namorados!",
    ]
)

HalloweenDonaldChatter = (
[ # Saudações
"Bem-vindo ao meu porto de Halloween!",
"Suba a bordo, se tiver doces!",
"Feliz Dia das Bruxas!",
"Feliz Dia das Bruxas, %!",
],
[ # Comentários
"Se pregar peças faz você se sentir ridiculamente ridículo, então vá ver o Rudy para ganhar uma guloseima!",
"Mas eu uso fantasia de marinheiro todos os dias!",
"Se pregar peças faz você se sentir ridiculamente ridículo, então vá ver o Rudy para ganhar uma guloseima!",
"Abóboras dão ótimas lanternas!",
"Se pregar peças faz você se sentir ridiculamente ridículo, então vá ver o Rudy para ganhar uma guloseima!",
"Eu nunca vi palmeiras com pernas peludas Antes!",
"Se pregar peças está fazendo você se sentir ridiculamente ridículo, então vá ver o Rudy para ganhar um presente!",
"Talvez eu seja um pirata no próximo Halloween!",
"Se pregar peças está fazendo você se sentir ridiculamente ridículo, então vá ver o Rudy para ganhar um presente!",
"Eu acho que as melhores guloseimas são estrelas-do-mar!",
"Se pregar peças está fazendo você se sentir ridiculamente ridículo, então vá ver o Rudy para ganhar um presente!",
"Vou te levar para pedir doces no porto!",
"Se pregar peças está fazendo você se sentir ridiculamente ridículo, então vá ver o Rudy para ganhar um presente!",
"Espero que aquelas aranhas fiquem nas árvores!",
"Se pregar peças está fazendo você se sentir ridiculamente ridículo, então vá ver o Rudy para ganhar um presente!",
"Como se chama um fantasma na água? Um BOO-y!",
"Se pregar peças está fazendo você se sentir ridiculamente ridículo, então vá ver o Rudy para ganhar um presente!" Uma delícia!",
"Espero que estejam curtindo nossa diversão de Halloween!",
],
[ # Adeus
"Partir para os sustos!",
"Feliz assombração!",
"Vou conferir as decorações assustadoras de Halloween."
]
)

ValentinesDonaldChatter = (
   [
   "Ahoy, eu sou o Donald!",
   "Feliz Dia dos Toons dos Namorados!",
   "Feliz Dia dos Toons dos Namorados, %!",
   ],
   [
   "Era para eu levar a Margarida para algum lugar no Dia dos Toons dos Namorados?",
   "Só mais uma volta no porto, depois compro alguma coisa para Margarida.",
   "O que a Margarida gostaria no Dia dos Toons dos Namorados?",
   "Esses corações na água são ótimos para aumentar as risadas!",
   "Façam uma festa de Dia dos Toons dos Namorados!",
   "Mostrem aos Cogs que vocês os amam com uma torta na cara!",
   "Vou ter que pegar uma Enguia Amore para a Margarida!",
   ], 
   [
   "Aloha!",
   "Dê lembranças aos Cogs!",
   ]
)

WinterDonaldCChatter = (
[ # Saudações
"Bem-vindos ao Cais de Barcos e Trenós do Donald!",
"Todos a bordo para o cruzeiro de Férias de Inverno!",
"Felizes Férias de Inverno!",
"Felizes Férias de Inverno, %!",
],
[ # Comentários
"Ouvi dizer que o Dante tem Presentes com um Boto, compartilhe uma música e ele pode ter um presente para você também!",
"O que você achou dos meus discursos de pato?",
"Ouvi dizer que o Dante tem Presentes com um Boto, compartilhe uma música e ele pode ter um presente para você também!",
"O que a neve está fazendo nos postes de luz?",
"Ouvi dizer que o Dante tem Presentes com um Boto, compartilhe uma música e ele pode ter um presente para você também!",
"É melhor que esta água não congele!",
"Ouvi dizer que o Dante tem Presentes com um Boto, compartilhe uma música e ele pode ter um presente para você Presente para você também!",
"Como eles colocaram as luzes naquelas árvores?",
"Ouvi dizer que o Dante tem presentes com um boto, compartilhe uma música e ele pode ter um presente para você também!",
"Este barco é melhor que um trenó! Ou não?",
"Ouvi dizer que o Dante tem presentes com um boto, compartilhe uma música e ele pode ter um presente para você também!",
"Eu não preciso de renas para puxar este barco!",
"Ouvi dizer que o Dante tem presentes com um boto, compartilhe uma música e ele pode ter um presente para você também!",
"Ainda bem que não sou um peru nesta época do ano!",
"Ouvi dizer que o Dante tem presentes com um boto, compartilhe uma música e ele pode ter um presente para você também!",
"Meu presente para você? Passeios de barco grátis!",
"Ouvi dizer que o Dante tem Presentes com um Boto, compartilhe uma música e ele pode ter um presente para você também!",
"Espero não receber um pedaço de carvão de novo!",
"Ouvi dizer que o Dante tem Presentes com um Boto, compartilhe uma música e ele pode ter um presente para você também!",
],
[ # Despedidas
"Todos em terra para a diversão do feriado!",
"Lembre-se de dar uma gorjeta ao motorista do barco na saída!",
"Aproveite as férias!",
]
)
...
WinterDonaldDChatter = (
        [ # Greetings
        "Bem-vindos ao Porto de Barcos e Trenós do Donald!",
        "Todos a bordo para o cruzeiro de Feriado de Inverno!",
        "Feliz Feriado de Inverno!",
        "Feliz Feriado de Inverno, %!",
        ],
        [ # Comments
        "O que você achou dos meus discursos sobre patos?",
        "O que a neve está fazendo nos postes de luz?",
        "É melhor que esta água não congele!",
        "Como eles conseguiram as luzes lá em cima naquelas árvores?",
        "Este barco é melhor que um trenó! Ou não é?",
        "Não preciso de renas para puxar este barco!",
        "Ainda bem que não sou um peru nesta época do ano!",
        "Meu presente para você? Passeios de barco grátis!",
        "Espero não pegar um pedaço de carvão de novo!",
        ],
        [ # Goodbyes
        "Todos em terra firme para a diversão do feriado!",
        "Lembre-se de dar uma gorjeta ao motorista do barco na saída!",
        "Aproveite as férias!",
        ]
    )
...
WesternPlutoChatter = (
        [# Greetings
        "Buu! Não se assuste, sou só eu... Pluto!",
        "Feliz Dia das Bruxas, parceiro!",
        "Feliz Dia das Bruxas, %!",
        ],
        [ # Comments
        "Fred Cavanhaque tem doces para travessuras, eles fazem ele sentir em Neve Doce Neve!",
        "Eu faço truques como guloseimas!",
        "Fred Cavanhaque tem doces para travessuras, eles fazem ele sentir em Neve Doce Neve!",
        "Mickey vai me levar para pedir doces mais tarde!",
        "Fred Cavanhaque tem doces para travessuras, eles fazem ele sentir em Neve Doce Neve!",
        "Parece mais férias de inverno do que Halloween!",
        "Fred Cavanhaque tem doces para travessuras, eles fazem ele sentir em Neve Doce Neve!",
        "Au! Isso é 'Doces-ou-Travessuras' em cachorro!",
        "Fred Cavanhaque tem doces para travessuras, eles fazem ele sentir em Neve Doce Neve!",
        "Espero que você esteja gostando da nossa diversão de Halloween!",
        "Fred Cavanhaque tem doces para travessuras, eles fazem ele sentir em Neve Doce Neve!",
        "Eu gosto de perseguir os Toons do Gato Preto!",
        ],
        [ # Goodbyes
        "Vou desenterrar um doce!", 
        "Vou ver se o Mickey tem alguns doces!",
...
WinterPlutoCChatter = (
        [# Greetings
        "Oi, eu sou o Pluto!",
        "Bem-vindos ao Brrgh, onde é inverno o ano todo!",
        "Feliz Feriado de Inverno!",
        "Feliz Feriado de Inverno, %",
        ],
        [ # Comments
        "O Abrão precisa de uma boa melodia, porque a Terra do Boneco de Neve é um lugar solitário para um Abominável!",
        "Eu mastiguei um floco de neve e fiquei congelado!",
        "O Abrão precisa de uma boa melodia, porque a Terra do Boneco de Neve é um lugar solitário para um Abominável!",
        "Isso é como viver em um globo de neve!",
        "O Abrão precisa de uma boa melodia, porque a Terra do Boneco de Neve é um lugar solitário para um Abominável!",
        "Queria estar perto de uma fogueira quentinha!",
        "O Abrão precisa de uma boa melodia, porque a Terra do Boneco de Neve é um lugar solitário para um Abominável!",
        "Arf! Arf! Preciso de um cachecol!",
        "O Abrão precisa de uma boa música, porque a Terra do Boneco de Neve é um lugar solitário para um Abominável!",
        "Pelo menos meu nariz não está vermelho e brilhante!",
        ],
        [ # Goodbyes
        "Tenham um ótimo feriado de inverno!",
        "Voltem sempre que quiserem neve!",
        "O Mickey vai me levar para cantar canções de natal!",
        ]
    )
...
WinterPlutoDChatter = (
        ...
        [ # Comments
        "Mastiguei um floco de neve e fiquei congelado!",
        "Isso é como viver em um globo de neve!",
        "Queria estar perto de uma fogueira quentinha!",
        "Arf! Arf! Preciso de um cachecol!",
        "Pelo menos meu nariz não está vermelho e brilhante!",
...
ShirtStylesDescriptions = {
    ...
    'vd_ss1' : "Toons dos Namorados, rosa com corações vermelhos (feminina)",
    'vd_ss2' : "Toons dos Namorados, vermelha com corações brancos",
    'vd_ss3' : "Toons dos Namorados, branca com corações alados (masculina)",
    'vd_ss4' : "Toons dos Namorados, rosa com corações flamejantes",
    'vd_ss5' : "Toons dos Namorados 2009, branca com cupido vermelho",
    'vd_ss6' : "Toons dos Namorados 2009, azul com verde e corações vermelhos",
