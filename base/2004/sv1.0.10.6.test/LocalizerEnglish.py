...
QuestsCogNewbieQuestObjective = 'Help a new Toon defeat %s'
...
RewardPanelMeritBarLabel = 'Merits'
...
GlobalStreetNames = {
    ...
    10000: ('to the', 'Bossbot HQ'),
    10100: ('to the', 'Bossbot HQ Lobby'),
    11000: ('to the', 'Sellbot HQ Courtyard'),
    11100: ('to the', 'Sellbot HQ Lobby'),
    11200: ('to the', 'Sellbot Factory'),
    11500: ('to the', 'Sellbot Factory'),
    12000: ('to the', 'Cashbot HQ'),
    12100: ('to the', 'Cashbot HQ Lobby'),
    13000: ('to the', 'Lawbot HQ'),
    13100: ('to the', 'Lawbot HQ Lobby') }
...
WelcomeValley = ('to', 'Welcome Valley')
FactoryNames = {
    0: 'Factory Mockup',
...
SpeedChatStaticText = {
    ...
    1105: "Let's go to Toontown Central!",
    1106: "Let's go to Donald's Dock!",
    1107: "Let's go to Minnie's Melodyland!",
    1108: "Let's go to Daisy Gardens!",
    1109: "Let's go to The Brrrgh!",
    1110: "Let's go to Donald's Dreamland!",
...
CagedToonPrepareBattleThree = "Hooray, I'm almost free!\x7Now you need to attack the V. P. Cog directly.\x7I've got a whole bunch of pies you can use!\x7Jump up and touch the bottom of my cage and I'll give you some pies.\x7Press the Ins key to throw pies once you've got them!"
...
CagedToonThankYou = "It's great to be free!\x7Thanks for all your help!\x7I am in your debt.\x7If you ever need help in battle, just give me a call!\x7Just click on the SOS button to call me.\x7Say--that V.P. Cog left behind your promotion papers.\x7I'll file them for you on the way out, so you'll get your promotion!"
...
BossElevatorRejectMessage = 'You can not board this elevator until you have earned a promotion.'
...
zone2TitleDict = {
    ...
    5836: ('April\xc2\x92s Showers and Tubs', ''),
...
FireworksNewYearsEveEnding = 'Toon HQ: Hope you enjoyed the show! Happy 2004!'
TIP_NONE = 0
TIP_GENERAL = 1
TIP_STREET = 2
TIP_MINIGAME = 3
...
FishSpeciesNames = {
    ...
    10: ('Holey Mackerel',),
    12: ('Dog Fish', 'Bull Dog Fish', 'Hot Dog Fish', 'Dalmation Dog Fish', 'Puppy Dog Fish'),
    ...
    32: ('Peanut Butter & Jellyfish', 'Grape PB&J Fish', 'Crunchy PB&J Fish', 'Strawberry PB&J Fish'),
    34: ('Devil Ray',) }
